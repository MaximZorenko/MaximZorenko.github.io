<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'id'               => 'header_icons_fils',
        'subsection'       => true,
        'customizer_width' => '450px',
        'fields'           => array(
            array(
                'id'       => 'header_icons_facebook_logo',
                'type'     => 'media',
                'url'      => true,
            ...
            array(
                'id'       => 'header_icons_instagram_logo',
                'type'     => 'media',
                'url'      => true,
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Icons', 'redux-framework-demo' ),
        'id'               => 'footer_icons_fils',
        'subsection'       => true,
        'customizer_width' => '450px',
        'fields'           => array(
            array(
                'id'       => 'footer_icons_facebook_logo',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Facebook', 'redux-framework-demo' ),
                'compiler' => 'true',
            ...
            array(
                'id'       => 'footer_icons_instagram_logo',
                'type'     => 'media',
                'url'      => true,
                'title'    => __( 'Instagram', 'redux-framework-demo' ),
                'compiler' => 'true',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'       => 'footer_contacts_adress',
                'type'     => 'text',
                'title'    => __( 'Footer Adress', 'redux-framework-demo' ),
                'default'  => '',
            ),
           array(
